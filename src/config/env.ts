...
const ENV = {
    ...
    URLS: {
        ...
        ADMIN_PORTAL_RESET_PASSWORD_URL: process.env.ADMIN_PORTAL_RESET_PASSWORD_URL
    },
    OTP_EXPIRES_IN_MINUTES: process.env.OTP_EXPIRES_IN_MINUTES,
    FORGOT_PASSWORD_EXPIRES_IN_MINUTES: process.env.FORGOT_PASSWORD_EXPIRES_IN_MINUTES,
